...
export default function AccountPage() {
  ...
  const sidebarItemClass = (isActive: boolean) =>
    `flex w-full items-center gap-3 rounded-[8px] px-4 py-3 text-left text-[15px] transition ${
      isActive
        ? "bg-[#f5f6ff] font-semibold text-slate-950"
    ...
    <main className="min-h-screen bg-[#f7f8fc] text-slate-900">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <div className="grid gap-6 lg:grid-cols-[250px_minmax(0,1fr)]">
          <aside className="flex rounded-[8px] border border-white/80 bg-white/80 p-5 shadow-[0_24px_60px_rgba(15,23,42,0.05)] backdrop-blur lg:min-h-[720px]">
            <div className="flex w-full flex-col justify-between gap-8">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-[8px] bg-[#ef4444] px-4 py-3 text-[15px] font-semibold text-white transition hover:bg-[#dc2626] disabled:cursor-not-allowed disabled:bg-[#fca5a5]"
              >
                <LogoutIcon />
