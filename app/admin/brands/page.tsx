  ...
  if (!userEmail) {
    return (
      <div className="mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-900">Admin Brands</h1>
  ...
  return (
    <section className="w-full space-y-6">
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
        <div className="flex flex-col gap-4 border-b border-gray-100 px-5 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage product brands, upload brand marks, and keep catalog branding organized.
            </p>
          </div>
        ...
        {brands.length === 0 ? (
          <AdminEmptyState title="No brands yet" description="Create your first brand to connect it with products." />
        ) : filteredBrands.length === 0 ? (
          <AdminEmptyState title="No matching brands" description="Try another search term." />
        ) : (
            ...
            <div className="flex items-start justify-between border-b border-slate-200 px-6 py-5">
              <div>
                ...
                <h2 className="mt-1 text-xl font-semibold text-slate-900">
                  {editingBrandId ? "Update brand details" : "Create a new product brand"}
                </h2>
              </div>
              <button
                type="button"
            ...
            <form className="space-y-5 px-6 py-6" onSubmit={handleSubmit}>
              <div className="grid gap-5 md:grid-cols-2">
                <div className="md:col-span-2">
                  <label htmlFor="brand-name" className="mb-1.5 block text-sm font-medium text-slate-700">
                    Brand Name
                  </label>
                  <input
                    id="brand-name"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="brand-slug" className="mb-1.5 block text-sm font-medium text-slate-700">
                    Slug
                  </label>
                  <input
                    id="brand-slug"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="brand-image-url" className="mb-1.5 block text-sm font-medium text-slate-700">
                    Brand Image
                  </label>
                  <input
                    id="brand-image-url"
                  ...
                  {form.image_url ? (
                    <div className="mt-4 flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-3">
                      <div className="h-16 w-16 overflow-hidden rounded-full bg-white">
                        <img src={form.image_url} alt="Brand preview" className="h-full w-full object-cover" />
                      </div>
