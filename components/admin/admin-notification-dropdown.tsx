...
const notifications = [
  {
    ...
    body: "A storefront request is waiting in the review queue.",
    time: "5 min ago",
  },
  {
    title: "Shipping profile draft",
    body: "Bangladesh shipping settings are ready for UI review.",
    time: "18 min ago",
  },
  {
    title: "Catalog moderation",
    body: "12 product listings were added to the moderation queue.",
    time: "1 hr ago",
  },
];
  ...
  return (
    <div className="relative">
      ...
      <AdminDropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-xl sm:w-[361px] lg:right-0"
      >
        <div className="mb-3 flex items-center justify-between border-b border-gray-100 pb-3">
          <h5 className="text-lg font-semibold text-gray-800">Notifications</h5>
          <button onClick={toggleDropdown} className="dropdown-toggle text-gray-500 transition hover:text-gray-700">
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          {notifications.map((notification) => (
            <li key={notification.title}>
              ...
              >
                <span className="relative flex h-10 w-10 items-center justify-center rounded-full bg-[#615FFF] text-sm font-semibold text-white">
                  P
                  <span className="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full border-[1.5px] border-white bg-emerald-500" />
                </span>
